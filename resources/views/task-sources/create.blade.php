...
@section('title', 'إضافة مصدر تكليف - متابعة التكليفات')
@section('page-title', 'إضافة مصدر تكليف جديد')
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
            <div class="bg-primary p-6 text-white">
                <h3 class="text-2xl font-black flex items-center gap-3">
                    <i class="fas fa-share-nodes text-accent"></i> إضافة مصدر تكليف جديد
                </h3>
            </div>

            <form method="POST" action="{{ route('task-sources.store') }}" class="p-8 space-y-6">
                @csrf
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                        ...
                        placeholder="مثال: السيد المحافظ">
                </div>
                ...
                <div class="pt-6 border-t border-slate-100">
                    <button type="submit"
                        ...
                        <i class="fas fa-save text-accent"></i> حفظ المصدر
                    </button>
                </div>
            </form>
        </div>
