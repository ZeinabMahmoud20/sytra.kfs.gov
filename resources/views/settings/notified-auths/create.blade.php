...
@section('title', 'إضافة جهة إخطار - الإعدادات')
@section('page-title', 'إضافة جهة إخطار جديدة')
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
            <div class="bg-primary p-6 text-white">
                <h3 class="text-2xl font-black flex items-center gap-3">
                    <i class="fas fa-bell text-accent"></i> إضافة جهة إخطار جديدة
                </h3>
            </div>

            <form method="POST" action="{{ route('settings.notified-auths.store') }}" class="p-8 space-y-6">
                @csrf
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="Notified_Auth" value="{{ old('Notified_Auth') }}" required
                        ...
                        placeholder="مثال: النيابة العامة">
                </div>
