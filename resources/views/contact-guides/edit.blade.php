...
@section('title', 'تعديل جهة اتصال - دليل الاتصال')
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
            <div class="bg-primary p-6 text-white">
                <h3 class="text-2xl font-black flex items-center gap-3">
                    <i class="fas fa-address-book text-accent"></i> تعديل جهة الاتصال
                </h3>
            </div>

            <form method="POST" action="{{ route('contact-guides.update', $contactGuide) }}" class="p-8 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="department_name" value="{{ old('department_name', $contactGuide->department_name) }}" required
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="manager_name" value="{{ old('manager_name', $contactGuide->manager_name) }}"
                        class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white focus:ring-2 focus:ring-accent/20 focus:border-accent outline-none">
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div class="space-y-1">
                        ...
                        <input type="text" name="phone_number" value="{{ old('phone_number', $contactGuide->phone_number) }}" dir="ltr"
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" name="landline_number" value="{{ old('landline_number', $contactGuide->landline_number) }}" dir="ltr"
                            class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white focus:ring-2 focus:ring-accent/20 focus:border-accent outline-none text-left">
                    </div>
                </div>
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="additional_phone" value="{{ old('additional_phone', $contactGuide->additional_phone) }}" dir="ltr"
                        class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white focus:ring-2 focus:ring-accent/20 focus:border-accent outline-none text-left">
                </div>
