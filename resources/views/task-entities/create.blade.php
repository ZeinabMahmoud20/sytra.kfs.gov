...
@section('title', 'إضافة جهة مختصة - متابعة التكليفات')
@section('page-title', 'إضافة جهة مختصة جديدة')
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
            <div class="bg-primary p-6 text-white">
                <h3 class="text-2xl font-black flex items-center gap-3">
                    <i class="fas fa-building text-accent"></i> إضافة جهة مختصة جديدة
                </h3>
            </div>

            <form method="POST" action="{{ route('task-entities.store') }}" class="p-8 space-y-6">
                @csrf
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                        ...
                        placeholder="مثال: مركز ومدينة بيلا">
                </div>
